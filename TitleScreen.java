...
public class TitleScreen extends ScreenFrame implements ActionListener{
	...
	private final Font TITLE_FONT = new Font("Brush Script MT", Font.BOLD, 40);
	...
	public TitleScreen() {
		...
		this.add(addCustomLabel("ICS3UI Culminating Assignment: Hill Adventure!", TITLE_COLOR, TITLE_FONT));
		//Add Students' names as a custom label
		this.add(addCustomLabel("Created by: Christopher Evans, Anthony", TITLE_COLOR, TITLE_FONT));
		...
		this.add(addCustomLabel("Date: Jan 13, 2023", TITLE_COLOR, TITLE_FONT));
		//Add Course Code as a custom label
		this.add(addCustomLabel("Class: ICS3UI", TITLE_COLOR, TITLE_FONT));
		
		//Button to go to MenuScreen
		jbtNxt = addCustomButton("Next", 200, 75, Color.black, Color.red, new Font("Brush Script MT", Font.BOLD, 20));
	...
	private JLabel addDividerLabel() {
		...
		JLabel label = addCustomLabel("- - - - - - - - - - - - - - - - - - - - - - - - - -", Color.black, TITLE_FONT);
